...
const dataFeed = fakeDataFeed.pressure;
...
class Pressure extends React.Component {
  ...
  handleChangeCalculator(event) {
    ...
    this.setState({
      ...
      atm: roundToThousandths(dataFeed.units[name].conversions['atm'].calculation(value)),
      bar: roundToThousandths(dataFeed.units[name].conversions['bar'].calculation(value)),
      pa: roundToThousandths(dataFeed.units[name].conversions['pa'].calculation(value)),
      psi: roundToThousandths(dataFeed.units[name].conversions['psi'].calculation(value)),
      torr: roundToThousandths(dataFeed.units[name].conversions['torr'].calculation(value))
    });
  }
