...
const dataFeed = fakeDataFeed.speed;
...
class Speed extends React.Component {
  ...
  handleChangeCalculator(event) {
    ...
    this.setState({
      ...
      kmh: roundToThousandths(dataFeed.units[name].conversions['kmh'].calculation(value)),
      ms: roundToThousandths(dataFeed.units[name].conversions['ms'].calculation(value)),
      mph: roundToThousandths(dataFeed.units[name].conversions['mph'].calculation(value)),
      fts: roundToThousandths(dataFeed.units[name].conversions['fts'].calculation(value)),
      knots: roundToThousandths(dataFeed.units[name].conversions['knots'].calculation(value))
    });
  }
