...
const dataFeed = fakeDataFeed.length;
...
class Length extends React.Component {
  ...
  handleChangeCalculator(event) {
    ...
    this.setState({
      ...
      km: roundToThousandths(dataFeed.units[name].conversions['km'].calculation(value)),
      m: roundToThousandths(dataFeed.units[name].conversions['m'].calculation(value)),
      cm: roundToThousandths(dataFeed.units[name].conversions['cm'].calculation(value)),
      mm: roundToThousandths(dataFeed.units[name].conversions['mm'].calculation(value)),
      µm: roundToThousandths(dataFeed.units[name].conversions['µm'].calculation(value)),
      nm: roundToThousandths(dataFeed.units[name].conversions['nm'].calculation(value)),
      mi: roundToThousandths(dataFeed.units[name].conversions['mi'].calculation(value)),
      yd: roundToThousandths(dataFeed.units[name].conversions['yd'].calculation(value)),
      ft: roundToThousandths(dataFeed.units[name].conversions['ft'].calculation(value)),
      inch: roundToThousandths(dataFeed.units[name].conversions['inch'].calculation(value)),
      nmi: roundToThousandths(dataFeed.units[name].conversions['nmi'].calculation(value))
    });
  }
