...
const dataFeed = fakeDataFeed.mass;
...
class Mass extends React.Component {
  ...
  handleChangeCalculator(event) {
    ...
    this.setState({
      ...
      t: roundToThousandths(dataFeed.units[name].conversions['t'].calculation(value)),
      kg: roundToThousandths(dataFeed.units[name].conversions['kg'].calculation(value)),
      g: roundToThousandths(dataFeed.units[name].conversions['g'].calculation(value)),
      it: roundToThousandths(dataFeed.units[name].conversions['it'].calculation(value)),
      ust: roundToThousandths(dataFeed.units[name].conversions['ust'].calculation(value)),
      st: roundToThousandths(dataFeed.units[name].conversions['st'].calculation(value)),
      lb: roundToThousandths(dataFeed.units[name].conversions['lb'].calculation(value)),
