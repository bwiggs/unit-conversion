...
const dataFeed = fakeDataFeed.angle;
...
class Angle extends React.Component {
  ...
  handleChangeCalculator(event) {
    ...
    this.setState({
      ...
      deg: roundToThousandths(dataFeed.units[name].conversions['deg'].calculation(value)),
      arcmin: roundToThousandths(dataFeed.units[name].conversions['arcmin'].calculation(value)),
      arcsec: roundToThousandths(dataFeed.units[name].conversions['arcsec'].calculation(value)),
      gon: roundToThousandths(dataFeed.units[name].conversions['gon'].calculation(value)),
      rad: roundToThousandths(dataFeed.units[name].conversions['rad'].calculation(value)),
      tr: roundToThousandths(dataFeed.units[name].conversions['tr'].calculation(value))
    });
  }
