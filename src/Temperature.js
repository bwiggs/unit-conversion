...
const dataFeed = fakeDataFeed.temperature;
...
class Temperature extends React.Component {
  ...
  handleChangeCalculator(event) {
    ...
    this.setState({
      ...
      c: roundToThousandths(dataFeed.units[name].conversions['c'].calculation(value)),
      f: roundToThousandths(dataFeed.units[name].conversions['f'].calculation(value)),
      k: roundToThousandths(dataFeed.units[name].conversions['k'].calculation(value))
    });
  }
